...
PROJECT_NAME = de-pg-theme-parks
...
# Execute python related functionalities from within the projects environment
...
security-test:
	...
	$(call execute_in_env, bandit -lll ./db/**/**.py)

## Run the flake8 code check
run-flake:
	$(call execute_in_env, flake8 ./db/**/**.py ./test/**.py)
...
## Run seed
seed:
	$(call execute_in_env, PYTHONPATH=${PYTHONPATH} python ./db/run_seed.py)
